...
Run native tests with sanitizers and coverage, then compile the ESP32 test target
without uploading. CI runs both checks. Include the problem, resulting behavior,
